...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception{
		http.cors()
			...
			.antMatchers(HttpMethod.GET, "/favourite-place/**", "/report/**").permitAll()
//			.antMatchers(HttpMethod.POST, "/resident", "/resident/search/**", "/resident/nextLot", "/resident/pageLimit", "/resident/sortBy/**").permitAll()
